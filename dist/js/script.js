...
// ADD CSS - - - - - - - - - - - - - - - - - - - -
addElement("head", "link", { rel: "stylesheet", href: "https://bitofbeans.github.io/jsWordleGame/dist/style/style.css" }); // Add CSS
...
jqueryscript.onload = () => {
    let script = addElement("body", "script", { src: "https://bitofbeans.github.io/jsWordleGame/dist/js/main.js", id: "index" });
